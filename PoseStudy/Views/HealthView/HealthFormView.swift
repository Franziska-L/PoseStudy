    ...
    var body: some View {
        ScrollView {
            VStack {
                ...
                HealthQuestionsView(viewModel: viewModel)
                MedicamentQuestionView(viewModel: viewModel)
                DiseasQuesionView(viewModel: viewModel)
                FitnessQuestionView(viewModel: viewModel)
...
struct MedicamentQuestionView: View {
    @StateObject var viewModel: HealthViewModel
...
struct FitnessQuestionView: View {
    @StateObject var viewModel: HealthViewModel
