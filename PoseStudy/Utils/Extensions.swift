...
extension String {
    ...
    static let positionInstr = "Stelle das Handy quer auf dem Handyhalter. Positioniere die Handyhalterunggi in ca. 1 m bis 1,5 m Abstand längs zu deinem Körper, sodass dein gesamter Körper seitlich zu sehen ist.\n\nWenn alles bereit ist kann es los gehen."
